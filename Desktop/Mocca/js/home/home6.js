...
;(function ($) {
  ...
  $(document).on('click touch', '#woosc_copy_url, #woosc_copy_btn', function (
    e,
  ) {
  ...
  if (woosc_vars.open_button !== '') {
    $(document).on('click touch', woosc_vars.open_button, function (e) {
      if (
        woosc_vars.open_button_action === 'open_page' &&
        woosc_vars.page_url !== '' &&
        woosc_vars.page_url !== '#'
      ) {
  ...
  $(document).on('click touch', '.woosc-menu-item a, .woosc-menu a', function (
    e,
  ) {
  ...
  function woosc_add_product(product_id) {
    ...
    if (limit) {
      ...
      if (woosc_vars.button_text_change === 'yes') {
        $('.woosc-btn[data-id="' + product_id + '"]').html(
    ...
    $.post(woosc_vars.ajax_url, data, function (response) {
      if (
        ...
        if (
          ...
          (open === 'first' && woosc_vars.open_bar === 'yes')
        ) {
          $('.woosc-bar-items')
            .html(response)
