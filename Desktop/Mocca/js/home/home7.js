...
;(function ($) {
    ...
    if ($this.hasClass('woosw-added')) {
      ...
      $.post(woosw_vars.ajax_url, data, function (response) {
        ...
        if (woosw_vars.button_action === 'list') {
          ...
          var message =
            '<div class="woosw-popup-inner"><div class="woosw-popup-content"><div class="woosw-popup-content-top"><span class="woosw-popup-close"></span></div><div class="woosw-popup-content-mid"><div class="woosw-popup-content-mid-message">'
  ...
  $(document).on('click touch', '#woosw_wishlist .woosw-popup-close', function (
    e,
  ) {
    woosw_wishlist_hide()
    e.preventDefault()
  })
  $(document).on('click touch', '#woosw_manage .woosw-popup-close', function (
    e,
  ) {
    woosw_manage_hide()
    e.preventDefault()
  ...
  $(document).on('click touch', '.woosw-menu-item a, .woosw-menu a', function (
    e,
  ) {
    e.preventDefault()
  ...
  $(document).on('click touch', '#woosw_copy_url, #woosw_copy_btn', function (
    e,
  ) {
    e.preventDefault()
